		...
		<>
			...
			<div className="text-center p-4">
				...
				<p className="text-gray-700 text-lg mb-4">
					Bem-vindo à nossa aplicação de gerenciamento de biblioteca!
					Este projeto demonstra o uso de várias tecnologias e padrões
					de design para criar uma aplicação robusta e eficiente para
					administrar uma biblioteca.
				</p>
				...
				<p className="text-gray-700 text-lg mb-4">
					...
					permitindo uma gestão eficaz da biblioteca:
				</p>
				<ul className="list-disc list-inside text-left text-lg mb-4">
					<li>
				...
				<p className="text-gray-700 text-lg">
					...
					práticas no desenvolvimento de software para gerenciamento
					de biblioteca, proporcionando uma experiência eficiente e
					organizada para administradores e usuários da biblioteca.
				</p>
			</div>
		</>
	);
